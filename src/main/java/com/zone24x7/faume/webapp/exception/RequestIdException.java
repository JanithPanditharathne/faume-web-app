...
/**
 * Class for getting request id from verification id exception.
 */
public class RequestIdException extends Exception{
     ...
     * @since 1.7
     */
    protected RequestIdException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
